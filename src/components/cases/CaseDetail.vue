        ...
        <div class="result-failure-section" v-if="executionResult.status === 'failed'">
          ...
          <el-collapse-transition>
            <div class="failure-detail" v-show="showErrorDetail">
              ...
              <!-- 快速修复建议 -->
              <div class="quick-fix-section" v-if="getQuickFixSuggestions(executionResult.failureMessage).length > 0">
                <div class="detail-label">
                ...
                <div class="quick-fix-list">
                  <div 
                    ...
                    v-for="(suggestion, index) in getQuickFixSuggestions(executionResult.failureMessage)" 
                    :key="index"
                  >
